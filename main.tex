...
% logo(s)
\setlength{\maxlogowidth}{57ex}  % manually adjust this width to have the logos centered in their own columns
\logoright{\includegraphics[height=5.2cm,width=13cm]{figures/logos/grav.png}}
\logoleft{\includegraphics[height=4.68cm,width=13cm]{figures/logos/ua.png}}
